  ...
  return (
    <div className="bg-slate-800/50 rounded-xl border border-amber-500/20 p-6">
      ...
      <svg viewBox="0 0 920 400" className="w-full h-auto" aria-label="The Double Hop supply chain from Middle East through Asian refineries to Australia">
        ...
        {/* Flow paths — crude to Hormuz (circle edge r=26 to rect left edge) */}
        ...
        {/* Hormuz to refineries (rect right edge x=250 to circle left edge cx-r=428) */}
        <path d="M 250,191 Q 340,100 428,85" fill="none" stroke="#f59e0b" strokeWidth="2" strokeDasharray="8 6" className="hop-flow" opacity="0.7" />
        <path d="M 250,191 Q 340,155 428,155" fill="none" stroke="#f59e0b" strokeWidth="2" strokeDasharray="8 6" className="hop-flow" opacity="0.7" />
        <path d="M 250,191 Q 340,225 428,230" fill="none" stroke="#f59e0b" strokeWidth="2" strokeDasharray="8 6" className="hop-flow" opacity="0.7" />
        <path d="M 250,191 Q 340,280 428,290" fill="none" stroke="#f59e0b" strokeWidth="2" strokeDasharray="8 6" className="hop-flow" opacity="0.7" />
        {/* Refineries to Australia (circle right edge cx+r=472 to Australia circle left edge 716) */}
        <path d="M 472,85 Q 590,140 716,240" fill="none" stroke="#22c55e" strokeWidth="2" strokeDasharray="8 6" className="hop-flow" opacity="0.7" />
        <path d="M 472,155 Q 590,190 716,245" fill="none" stroke="#22c55e" strokeWidth="2" strokeDasharray="8 6" className="hop-flow" opacity="0.7" />
        <path d="M 472,230 Q 590,240 716,252" fill="none" stroke="#22c55e" strokeWidth="2" strokeDasharray="8 6" className="hop-flow" opacity="0.7" />
        <path d="M 472,290 Q 590,280 716,258" fill="none" stroke="#22c55e" strokeWidth="2" strokeDasharray="8 6" className="hop-flow" opacity="0.7" />
        ...
        {/* Transit time labels — larger font, lighter colour, clear of paths */}
        <text x="590" y="110" textAnchor="middle" fill="#94a3b8" fontSize="11" fontStyle="italic" fontWeight="500">~15 days</text>
        <text x="600" y="190" textAnchor="middle" fill="#94a3b8" fontSize="11" fontStyle="italic" fontWeight="500">8–14 days</text>
        <text x="600" y="265" textAnchor="middle" fill="#94a3b8" fontSize="11" fontStyle="italic" fontWeight="500">~7 days</text>
